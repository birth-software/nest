...
#define llvm_initialize_macro(target) \
    ...
    fn void LLVMTargetMachineEmit(TargetMachine* TM, Module* Mod, raw_pwrite_stream &OS, CodeGenFileType ft) {
    }


    EXPORT String llvm_codegen(CodegenOptions options, String object_path)
    {
